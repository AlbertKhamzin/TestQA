...
@Описание: экспортный сценарий, который загружает покупателей
@ПримерИспользования: И загружаю тестовый набор элементов справочника Контрагенты из папки 'Покупатели'
Сценарий: загружаю тестовый набор элементов справочника Контрагенты из папки 'Покупатели'
