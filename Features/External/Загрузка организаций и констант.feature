...
@Описание: экспортный сценарий, который перезаполняет значение всех констант
@ПримерИспользования: И заполняю значение всех констант значениями по умолчанию

Сценарий: заполняю значение всех констант значениями по умолчанию
...
@ТипШага: Загрузка данных
@Описание: экспортный сценарий, который загружает тесовый набор организаций
@ПримерИспользования: И загружаю тестовый набор элементов справочника Организации
Сценарий: загружаю тестовый набор элементов справочника Организации
